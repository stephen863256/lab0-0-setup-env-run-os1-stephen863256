...
#line 2 "/workspaces/lab0-0-setup-env-run-os1-stephen863256/qemu-7.0.0/hw/sh4/trace-events"
...
static inline void _nocheck__trace_sh7750_portb(uint16_t prev, uint16_t cur, uint16_t pdtr, uint16_t pctr)
{
    if (trace_event_get_state(TRACE_SH7750_PORTB) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 3 "/workspaces/lab0-0-setup-env-run-os1-stephen863256/qemu-7.0.0/hw/sh4/trace-events"
