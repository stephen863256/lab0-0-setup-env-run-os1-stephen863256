...
PKGVERSION=
SRC_PATH=/workspaces/lab0-0-setup-env-run-os1-stephen863256/qemu-7.0.0
TARGET_DIRS=riscv64-softmmu riscv64-linux-user
CONFIG_USBFS=y
CONFIG_GIO=y
...
ROMS=optionrom
MAKE=make
PYTHON=/home/codespace/.python/current/bin/python3 -B
GENISOIMAGE=
MESON=/home/codespace/.python/current/bin/python3 -B /workspaces/lab0-0-setup-env-run-os1-stephen863256/qemu-7.0.0/meson/meson.py
NINJA=/usr/bin/ninja
CC=cc
HOST_CC=cc
AR=ar
